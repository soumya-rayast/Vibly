      ...
      <div className="container mx-auto space-y-12">
        ...
        <section className="space-y-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <h2 className="text-3xl font-bold tracking-tight text-primary">Your Friends</h2>
        ...
        <section className="space-y-6">
          <div>
            <h2 className="text-3xl font-bold tracking-tight text-primary">Meet New Learners</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedUsers.map((user) => {
                ...
                return (
                  <div
                    key={user._id}
                    className="card bg-base-100 border shadow-sm hover:shadow-md transition duration-300"
                  >
